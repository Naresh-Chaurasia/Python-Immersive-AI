...
"""
1_query-expansion.py:
Implements a LangChain-based query expansion tool that rewrites one user question into multiple paraphrased variations using an OpenAI model and structured Pydantic output parsing.  
Useful for improving search, retrieval, or RAG performance by generating alternate phrasings while preserving the original intent.
