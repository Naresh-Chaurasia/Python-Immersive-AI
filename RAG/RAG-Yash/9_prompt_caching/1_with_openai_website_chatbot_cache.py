...
"""
1_with_openai_website_chatbot_cache.py
Implements an optimized RAG query processor with caching, timing metrics, and performance tracking to improve response speed and efficiency.  
Enhances retrieval-based QA by measuring latency, reusing cached results, and providing detailed context‑driven answers from scraped web content.
