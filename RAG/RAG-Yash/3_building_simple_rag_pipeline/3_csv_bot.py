...
"""
3_csv_bot.py:
Implements a CSV-based RAG pipeline that loads data, splits it into chunks, creates embeddings, and enables question–answering using FAISS and an LLM.  
Allows users to query structured CSV data with contextual answers and traceable source snippets.
