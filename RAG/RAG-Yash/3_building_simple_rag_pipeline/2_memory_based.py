...
"""
2_memory_based.py:
Creates a conversational RAG-based chatbot over a website by scraping content, chunking it, embedding with FAISS, and enabling context-aware Q\&A with memory.  
Focuses on multi-turn interaction using `ConversationalRetrievalChain` for a more natural chat experience.
