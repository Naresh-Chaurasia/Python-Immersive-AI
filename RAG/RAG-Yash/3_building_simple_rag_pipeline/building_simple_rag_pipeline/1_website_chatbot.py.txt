...
"""
1_website_chatbot.py:
Builds a complete Retrieval-Augmented Generation (RAG) pipeline that scrapes a website, chunks content, creates embeddings (FAISS), and answers user queries using an LLM.  
Demonstrates end-to-end flow from raw web data → vector search → context-aware QA responses.
