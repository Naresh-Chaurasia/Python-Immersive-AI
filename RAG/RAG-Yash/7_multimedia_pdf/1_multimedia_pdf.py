...
1_multimedia_pdf.py:
Builds a multimodal PDF RAG system with a Gradio UI that extracts text, images, and tables, performs query expansion, and answers questions using vector search + LLM.  
Enables interactive document Q\&A with traceability (chunks/logs) and awareness of visual/tabular content.

Multimodal RAG: The system handles multiple data types: Text, Images, Tables, Graphs, Diagrams
"""
